...
namespace Web.Controllers
{
    ...
    public class PersonController : ControllerBase
    {
        ...
        public PersonController(ApplicationDbContext context, IBusiness<PersonDTO, PersonDTO> personBusiness, ILogger<PersonController> logger)
        {
            _context = context;
        ...
        public async Task<IActionResult> GetPersonById(int id)
        {
            ...
            {
                _logger.LogInformation(ex, "Validacion fallida para Obtener Person con ID: {PersonId}", id);
        ...
        public async Task<IActionResult> GetAvailablePersons()
        {
            try
            {
                var availablePersons = await _context.Set<Person>()
